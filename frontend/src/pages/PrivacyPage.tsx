        ...
        <div className="privacy-content">
          ...
          <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
            <li>
              ...
              we collect your name, email address, and login credentials.
            </li>
            <li>
            ...
            <li>
              ...
              content ratings, or talent interests to personalize
              recommendations.
            </li>
          </ul>
          ...
          <ul style={{ listStyle: 'none', paddingLeft: 0 }}>
            <li>
              To deliver and maintain a high-quality streaming experience.
            </li>
            <li>
          ...
          <p>
            ...
            trusted third-party providers only when necessary and with
            safeguards.
          </p>
