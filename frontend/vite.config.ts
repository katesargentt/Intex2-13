  ...
  server: {
    ...
    headers: {
      'Content-Security-Policy':
        ...
        "connect-src 'self' http://localhost:5000 https://localhost:5000 https://intexrecommender-bxeme7cmccahabet.westus-01.azurewebsites.net https://accounts.google.com https://oauth2.googleapis.com; " + // ✅ FIXED THIS LINE
